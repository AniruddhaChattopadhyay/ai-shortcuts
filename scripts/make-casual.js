...
function run(argv) {
  ...
  var payload = {
    "model": model,
    "messages": [
      { "role": "system", "content": "Rewrite the user's text in a casual, friendly, and conversational tone. Make it sound natural and approachable. Only output the rewritten text." },
