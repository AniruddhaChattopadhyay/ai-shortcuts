...
function run(argv) {
  ...
  var systemPrompt = "Expand the user's text with more detail, examples, or explanation while keeping the same tone and message. Only output the expanded text.";
