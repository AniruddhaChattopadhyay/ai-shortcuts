...
function run(argv) {
  ...
  var systemPrompt = "Explain the user's text in simple, easy-to-understand language. Avoid jargon and use everyday words. Only output the simplified explanation.";
